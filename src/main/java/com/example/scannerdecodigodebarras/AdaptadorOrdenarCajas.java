...
public class AdaptadorOrdenarCajas extends FirestoreRecyclerAdapter<Elemento, AdaptadorOrdenarCajas.ViewHolder> {

    public AdaptadorOrdenarCajas(@NonNull FirestoreRecyclerOptions<Elemento> options) {
        super(options);
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.adaptador_ordenar_cajas, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            codigo = itemView.findViewById(R.id.textCodigoOrdCajas);
            nombre = itemView.findViewById(R.id.textNombreOrdCajas);
            filial = itemView.findViewById(R.id.textFilialOrdCajas);
            checkBox = itemView.findViewById(R.id.CheckBoxOrdenarCajas);
